...
import com.zdkj.uilib.databinding.UixDialogContentSimpleBinding
...
class SimpleContent private constructor(): ViewBindingDialogContent<UixDialogContentSimpleBinding>() {
    ...
    @ColorInt
    private var contentColor: Int? = GlobalConfig.contentTextColor
    @Size
    private var contentSize: Float = GlobalConfig.contentTextSize
