...
class NormalButton : AppCompatButton {
    ...
    private var textNormalColor: Int = GlobalConfig.textColor
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(context, attrs, defStyleAttr) {
        if (attrs != null) {
            ...
            textNormalColor = typedArray.getColor(R.styleable.NormalButton_btn_text_normal_color, textNormalColor)
